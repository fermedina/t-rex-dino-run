...
class PlayScene extends Phaser.Scene {
  ...
  update(time, delta) {
    ...
    // Destroy obsticle after disappear by the left 
  ...
  placeObsticle() {
    ...
    const obsticlesNum = Math.floor(Math.random() * 7) + 1;
    ...
    if (obsticlesNum > 6) {
      ...
      obsticle = this.obsticles.create(width + distance, height, `obsticle-${obsticlesNum}`);
